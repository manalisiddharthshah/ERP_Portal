                                        ...
                                        <table class="table table-striped table-bordered file-export">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th>Depatment Name   <i class="fas fa-sort"></i></th>
                                                    <th>Manager Name   <i class="fas fa-sort"></i></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center text-secondary">
                                                    ...
                                                    @if(Auth::user()->isAdmin())
                                                    <td>
                                                        <form method="POST" action="{{ route('department.destroy', ['id' => $department->id]) }}" onsubmit = "return confirm('Are you sure?')">
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        
                                                    <a href="{{route('department.edit',$department->id)}}" title="Edit" class="text-primary editBtn"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
