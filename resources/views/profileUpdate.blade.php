                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                    <h4 class="card-title" id="hidden-label-form-center">Update Profile</h4>
                                        ...
                                        <form action="{{url('/update-profile',$user_login->id)}}" method="post" class="form-horizontal">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="email" id="name" value="{{$user_login->email}}" placeholder="Name" readonly="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="phone" id="name" value="{{$user_login->phone}}" placeholder="Name">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea class="form-control" name="address" placeholder="Your Address" id="useraddress">{{$user_login->address}}</textarea>
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="userTypeId" id="userTypeId" class="form-control">
                                                            @foreach($userType as $userType)
                                                                <option value="{{$userType->id}}"{{$user_login->userTypeId==$userType->id?' selected':''}}>{{$userType->userType}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="deptId" id="deptId" class="form-control">
                                                            @foreach($department as $department)
                                                                <option value="{{$department->id}}"{{$user_login->deptId==$department->id?' selected':''}}>{{$department->deptName}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="officeId" id="officeId" class="form-control">
                                                            @foreach($offices as $offices)
                                                                <option value="{{$offices->id}}"{{$user_login->officeId==$offices->id?' selected':''}}>{{$offices->officeName}}</option>
                                                            @endforeach
                                                        </select>
